...
import { createParameter } from '../../actions/auth';
...
export default function AddParameterModal({ isOpen, onClose, paramType, onSuccess }: AddParameterModalProps) {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    if (result.error) {
      ...
      Swal.fire({
        title: 'Sukses!',
        text: 'Data master baru berhasil ditambahkan.',
        icon: 'success',
        timer: 1500,
      ...
      <div className="card animate-fade-in" style={{ 
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem' }}>
            <label style={{ fontSize: '0.75rem', fontWeight: 700, color: '#475569' }}>{getLabel().toUpperCase()}</label>
            <input 
              name="param_name" 
              type="text" 
              required 
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem' }}>
            <label style={{ fontSize: '0.75rem', fontWeight: 700, color: '#475569' }}>KODE (OPSIONAL)</label>
            <input 
              name="param_code" 
              type="text" 
