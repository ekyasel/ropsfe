                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', minWidth: '1200px' }}>
                  <thead>
                    <tr style={{ backgroundColor: '#f8fafc', borderBottom: '1px solid #e2e8f0' }}>
                      <th style={{ padding: '16px 20px', fontSize: '0.75rem', fontWeight: 800, color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.05em', width: '50px', textAlign: 'center' }}>No</th>
                      ...
                      <th style={{ padding: '16px 20px', fontSize: '0.75rem', fontWeight: 800, color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.05em' }}>R.Operasi</th>
                    ...
                    {filteredRegistrations.map((reg, index) => {
                      ...
                      return (
                        <tr key={reg.id} style={{
                          ...
                          <td style={{ padding: '18px 20px', textAlign: 'center', fontWeight: 600, color: '#475569', fontSize: '0.9rem' }}>
                          ...
                          <td style={{ padding: '18px 20px' }}>
                            ...
                            <div style={{ fontSize: '0.8rem', color: '#64748b' }}>{reg.umur_tahun} {reg.jenis_umur || 'Thn'}</div>
                          </td>
                          <td style={{ padding: '18px 20px' }}>
